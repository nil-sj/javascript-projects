...
// if (commandOverride || (fuelLevel > 5000 && engineTemperature <= 2500 && engineIndicatorLight !== "red blinking" && engineTemperature <= 3500)) {
//     console.log("Launch the shuttle.")
// } else {
//     console.log("Do not launch the shuttle.")
// }
